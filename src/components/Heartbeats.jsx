...
const getStreamStatus = (stream) => {
    ...
    const peer = Object.values(stream.peers || {})[0]; // On récupère le premier peer
...
const Heartbeats = () => {
    ...
    return (
        <Box className="p-6">
            <Typography variant="h5" className="mb-4 font-semibold text-gray-800 text-center">
                ...
                <Table>
                    <TableHead>
                        <TableRow className="bg-gray-100">
                            ...
                            <TableCell className="font-semibold">hb#1 RX</TableCell>
                            <TableCell className="font-semibold">hb#1 TX</TableCell>
                        </TableRow>
                    </TableHead>
